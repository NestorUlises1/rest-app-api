...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_update_recipe_assign(self):
        #Test assignig an existing tag when updating a recipe
    ...
    def test_update_recipe_assign_ingredients(self):
        #Test assignig an existing ingredient when updating a recipe
